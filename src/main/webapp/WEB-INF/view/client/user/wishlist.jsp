							...
							<tbody>
								<tr>
									<td><a href="#" class="text-center"><img
											src="img/wishlist/1.png" alt=""> </a></td>
									<td><a href="single-product.html">More-Or-Less</a></td>
									<td>Product 14</td>
									<td>In Stock</td>
								...
								<tr>
									<td><a href="#" class="text-center"><img
											src="img/wishlist/2.png" alt=""> </a></td>
									<td><a href="single-product.html">Aliquam Consequat</a></td>
									<td>Product 14</td>
									<td>In Stock</td>
