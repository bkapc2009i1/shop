							...
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse"
										...
										class="fa fa-list-ol"></i> Order history and details
									</a>
								</h4>
							</div>
							...
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										class="fa fa-file-o"></i> My credit slips
									</a>
								</h4>
							</div>
							<div id="collapseTwo" class="panel-collapse collapse"
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-12">
											<div class="account-title">
												<h4>Credit slips you have received after canceled
													orders.</h4>
											</div>
							...
							<div class="panel-heading" role="tab" id="headingThree">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										class="fa fa-building-o"></i> My addresses
									</a>
								</h4>
							</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="my-address">
												<p>Please configure your default billing and delivery
													addresses when placing an order. You may also add
													additional addresses, which can be useful for sending gifts
													or receiving an order at your office.</p>
												<div class="account-title">
													<h4>Your addresses are listed below.</h4>
												</div>
												<p>Be sure to update your personal information if it has
													changed.</p>
												<div class="row">
							...
							<div class="panel-heading" role="tab" id="headingFour">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										class="fa fa-user"></i> My personal information
									</a>
								</h4>
							</div>
										...
										<div class="delivery-details">
											<form action="#">
												<div class="list-style">
													<div class="account-title">
														<h4>Please be sure to update your personal
															information if it has changed.</h4>
													</div>
													<div class="form-name">
