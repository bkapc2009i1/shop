		...
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="checkout-banner hidden-xs">
					<a href="#"> <img src="img/checkout/checkout_banner.jpg" alt="">
					</a>
				</div>
							...
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse"
										...
										aria-expanded="true" aria-controls="collapseOne"> Step 1:
										Checkout Options <i class="fa fa-caret-down"></i>
									</a>
								</h4>
							</div>
							...
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										aria-expanded="false" aria-controls="collapseTwo"> Step 2:
										Account & Billing Details <i class="fa fa-caret-down"></i>
									</a>
								</h4>
							</div>
							<div id="collapseTwo" class="panel-collapse collapse"
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-6">
											<div class="account-details">
												...
												<div class="form-box">
													<div class="form-name">
														<label>E-mail <em>*</em>
														</label> <input type="email" placeholder="E-mail">
													</div>
												</div>
												<div class="form-box">
													<div class="form-name">
														<label>Telephone <em>*</em>
														</label> <input type="text" placeholder="Telephone">
													</div>
												</div>
												<div class="form-box">
													<div class="form-name">
														<label>Fax </label> <input type="text" placeholder="Fax">
													</div>
												</div>
												<h4>Your Password</h4>
												<div class="form-box">
												...
												<div class="form-box">
													<div class="form-name">
														...
														</label> <input type="password" placeholder="Password Confirm">
													</div>
												</div>
												<div class="checkbox">
													<input type="checkbox" name="newsletter">I wish to
													subscribe to the Malias1 newsletter.
												</div>
												<div class="checkbox">
										...
										<div class="col-sm-6">
											<div class="checkout-collapse">
												...
												<div class="form-box">
													<div class="form-name">
														<label>Address 1 <em>*</em>
														</label> <input type="text" placeholder="Address 1">
													</div>
												</div>
												<div class="form-box">
													<div class="form-name">
														<label>Address 2 <em>*</em>
														</label> <input type="text" placeholder="Address 2">
													</div>
												</div>
												<div class="form-box">
													<div class="form-name">
												...
												<div class="form-box">
													<div class="form-name">
														<label>Post Code <em>*</em>
														</label> <input type="text" placeholder="Post Code">
													</div>
												</div>
												<div class="form-box">
													<div class="form-name">
												...
												<div class="form-box">
													<div class="form-name">
														<label> State/Province </label> <select>
															<option value="1">---Please select---</option>
									...
									<div class="privacy-policy">
										I have read and agree to the <a href="#">Privacy Policy</a> <input
							...
							<div class="panel-heading" role="tab" id="headingThree">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										aria-expanded="false" aria-controls="collapseThree"> Step
										3: Delivery Details <i class="fa fa-caret-down"></i>
									</a>
								</h4>
							</div>
							...
							<div class="panel-heading" role="tab" id="headingFour">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										aria-expanded="false" aria-controls="collapseFour"> Step
										4: Delivery Method <i class="fa fa-caret-down"></i>
									</a>
								</h4>
							</div>
							...
							<div class="panel-heading" role="tab" id="headingFive">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										aria-expanded="false" aria-controls="collapseFive"> Step
										5: Payment Method <i class="fa fa-caret-down"></i>
									</a>
								</h4>
							</div>
								...
								<div class="panel-body">
									<div class="patment-method">
										<p>Please select the preferred payment method to use on
											this order.</p>
										<div class="radio">
											<input type="radio" checked="" value="shipping-method">Cash
											On Delivery
										</div>
										<p>
											<strong> Add Comments About Your Order</strong>
							...
							<div class="panel-heading" role="tab" id="headingSix">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										...
										aria-expanded="false" aria-controls="collapseSix"> Step 6:
										...
										<div class="table-responsive">
											<table class="table table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td><a href="#">Aliquam Consequat</a></td>
														<td>Product 14</td>
														<td>1</td>
														<td>$90.00</td>
														<td>$90.00</td>
