...
<head>
        ...
        <link rel="stylesheet" href="/client/lib/css/nivo-slider.css">
        <link rel="stylesheet" href="/client/lib/css/preview.css">
        <link rel="stylesheet" href="/client/css/animate.css">
        <link rel="stylesheet" href="/client/css/magic.css">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <div class="dashboard">
                                ...
                                <div class="cart-menu">
                                    <ul>
                                        <li><a href="#"> <img src="/client/img/icon-cart.png" alt=""> <span>2</span> </a>
                                            <div class="cart-info">
                                                <ul>
                                                    <li>
                                                        <div class="cart-img">
                                                            <img src="/client/img/cart/1.png" alt="">
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="cart-img">
                                                            <img src="/client/img/cart/2.png" alt="">
                                                        </div>
                                                        <div class="cart-details">
                                                            <a href="#">Fusce aliquam</a>
                                                            <p>1 x $777.00</p>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mega-women"><a href="shop.html">Women</a>
                                            <div class="mega-menu women">
                                                ...
                                                <div class="part-2">
                                                    <a href="#">
                                                        <img src="/client/img/banner/menu-banner.png" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
