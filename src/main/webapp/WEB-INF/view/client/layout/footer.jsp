<!-- footer top area start -->
                            ...
                            <div class="twitter-feed">
                                <div class="twitter-article">
                                    <div class="twitter-img">
                                        <a href="#">
                                            <img src="/client/img/twitter/twitter-1.png" alt="">
                                        </a>
                                    </div>
        ...
        <script src="/client/js/vendor/jquery-1.12.1.min.js"></script>
        <script src="/client/js/bootstrap.min.js"></script>
        <script src="/client/js/wow.min.js"></script>
        <script src="/client/js/jquery-price-slider.js"></script>
        <script src="/client/lib/js/jquery.nivo.slider.js"></script>
        <script src="/client/lib/home.js"></script>
        <script src="/client/js/jquery.meanmenu.js"></script>
